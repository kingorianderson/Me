      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className="contact_option">
            <i className="contact_option-icon">
              <MdEmail />
            </i>
            <h4>Email</h4>
            <h5>contact@kingori.co.ke</h5>
            <a
              href="mailto:kingorianderson@gmail.com"
              className="contact_button"
              target="_blank"
            >
              Send a message
              <i className="contact_button-icon">
                <BsArrowRight />
              </i>
            </a>
          </article>
          <article className="contact_option">
            ...
            <h5>0712333631</h5>
            <a
              href="https://api.whatsapp.com/send?phone=+254712333631"
              className="contact_button"
              target="_blank"
            >
              Send a message
