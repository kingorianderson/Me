  ...
  return (
    <footer>
      ...
      <div className="footer_socials">
        <a href="https://www.linkedin.com/in/andersonkingori/" className='footer_social'><FaLinkedin/></a>
        <a href="https://github.com/kingorianderson/" className='footer_social'><FaGithub/> </a>
      </div>
